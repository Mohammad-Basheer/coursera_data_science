...
output_dir <- paste(project_dir, "/OutputFiles", sep="")
...
step4_output <- paste(output_dir, "/step4_clean_data.csv", sep="")
...
#uncomment for separate file per subject
#step5_clean_data_subjects <- step5_clean_data[!is.na(step5_clean_data$Subjects),]
#for(i in unique(step5_clean_data$Subjects)){
#  if(!is.na(i)){
#    curr <- step5_clean_data[step5_clean_data$Subjects == i & !is.na(step5_clean_data$Subjects),][,-1]
#    c_fname <- paste("/subject_",as.character(i),".txt",sep="")
#    c_fname_abs <- paste(output_dir, c_fname,sep="")
#    print(c_fname_abs)
#    write.table(curr,c_fname_abs,sep=",",row.names=FALSE)  
#  }
#}
step5_clean_data_fname<- paste(output_dir, "/step5_clean_data.csv",sep="")
write.table(step5_clean_data,step5_clean_data_fname,sep=",",row.names=FALSE)
#---> STEP 5 DONE
